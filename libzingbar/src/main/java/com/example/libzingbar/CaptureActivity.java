...
import com.example.libzingbar.zbar.camera.CameraManager;
import com.example.libzingbar.zbar.decode.CaptureActivityHandler;
import com.example.libzingbar.zbar.decode.InactivityTimer;
import com.example.libzingbar.zbar.decode.RGBLuminanceSource;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
	...
	private void onListener(){
		...
		tvAlbum.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(CaptureActivity.this,PictureActivity.class);
